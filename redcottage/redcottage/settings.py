"""
Django settings for redcottage project.
...
SECRET_KEY = 'django-insecure-z9xyua9j^!*s8phl&*px#mtntom*s1y)@6_%mwvp7am(ciu78_'
...
WSGI_APPLICATION = 'redcottage.wsgi.application'
